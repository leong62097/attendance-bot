...
STAFF_NAMES = [
    ...
    "颖杰", "卢卡", "瑞安", "雪美", "雪玲", "阿宝", "阿凯", "小鹿",
    "萌神", "小马", "不不", "路路", "十一", "小明", "小康", "维尼",
    "阿煌", "金兰", "小成", "丽小", "阿弟", "小迈", "柠柠", "文南",
    "里卡", "安妮", "欧迪", "小香", "杰伦", "娜婷", "十三", "小平",
    "路易斯", "胡萝卜", "鸡仔", "柒柒", "官成", "小水", "子龙", "小西",
    "明惠", "小雪", "梦瑶", "沈三", "唐勋", "小宁", "倪倪", "小鼠",
    "米儿", "丽莎", "小陶", "小媛", "小杨", "怼怼", "白鹿", "浩哲",
    "小柳", "黄丽", "荆川", "怀宝", "卢雨", "玉玉", "小白", "月亮",
    "玲玲", "小草", "胜利", "宁宁", "阿森", "秀妍", "阿花", "小漫",
    "燕子", "菠萝", "小依", "大球", "知夏", "琪琪", "苏苏", "小叶",
    "粉亿", "以沫", "星财", "依依", "啊豪", "晶晶", "雅婷", "瑶瑶",
    "韩新", "关智", "小蓝", "金金", "阿峰", "小婷"
]
