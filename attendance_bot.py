...
STAFF_NAMES = [
    "小鑫" ,"二狗", "青柚", "小崔", "逍遥", "余果", "阿良", "小凡",
    "美鹅", "杰邓", "实惠", "关智", "靖茹", "七月", "小玫", "颖杰", "卢卡", "瑞安",
    "雪美", "雪玲", "阿宝", "阿凯", "小鹿", "萌神", "小马", "不不", "路路", "小猪",
    "不留", "十六", "阿旺", "M16", "十一", "小明", "小康", "小E", "维尼", "杰森",
    "阿煌", "金兰", "小成", "丽小", "阿弟", "小迈", "柠柠", "文南", "小布", "啊宏",
    "里卡", "安妮", "欧迪", "小香", "杰伦", "娜婷", "十三", "小平", "路易斯", "胡萝卜",
    "可可", "鸡仔", "柒柒", "官成", "小水", "子龙", "小西", "明惠", "小雪", "佳佳",
    "梦瑶", "沈三", "唐勋", "小宁", "李顺", "倪倪", "小鼠", "米儿", "丽莎", "小草",
    "小陶", "小媛", "麦子", "小杨", "怼怼", "白鹿", "西西", "浩哲", "小柳", "黑狼",
    "小曼", "宁宁", "黄丽", "秀妍", "荆川", "怀宝", "卢雨", "玉玉", "胜利", "杰克",
    "小白", "月亮", "金金", "贵天", "通邦", "阿森", "土豆", "玲玲", "阿花", "小龙",
]
