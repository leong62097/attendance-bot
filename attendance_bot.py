...
STAFF_NAMES = [
    ...
    "里卡", "安妮", "小香", "杰伦", "娜婷", "十三", "小平", "路易斯",
    "胡萝卜", "鸡仔", "官成", "子龙", "小西", "明惠", "小雪", "梦瑶",
    "沈三", "唐勋", "小宁", "倪倪", "小鼠", "米儿", "小陶", "小媛",
    "小杨", "怼怼", "白鹿", "浩哲", "小柳", "黄丽", "荆川", "怀宝",
    "卢雨", "玉玉", "小白", "月亮", "玲玲", "小草", "胜利", "宁宁",
    "阿森", "秀妍", "阿花", "小漫", "燕子", "菠萝", "小依", "知夏",
    "琪琪", "小叶", "粉亿", "以沫", "星财", "依依", "晶晶", "雅婷",
    "韩新", "关智", "小蓝", "金金", "阿峰", "小婷", "琳娜", "小鱼",
    "雅雅", "小瑶", "可可"
]
