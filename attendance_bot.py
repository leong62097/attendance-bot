...
STAFF_NAMES = [
    "二狗", "青柚", "小崔", "逍遥", "余果", "美鹅", "杰邓", "实惠",
    "七月", "小玫", "颖杰", "卢卡", "瑞安", "雪美", "雪玲", "阿宝",
    "阿凯", "小鹿", "萌神", "小马", "不不", "路路", "十六", "阿旺",
    "十一", "小明", "小康", "维尼", "阿煌", "金兰", "小成", "丽小",
    ...
    "玲玲", "杰克", "黑狼", "小草", "胜利", "啊宏", "宁宁", "阿森",
    "秀妍", "阿花", "李顺", "小漫", "小城", "美林", "清清", "燕子",
    "菠萝", "小依", "大球", "知夏", "琪琪", "苏苏", "小叶", "菲娅",
    "小月", "粉亿", "小青"
]
